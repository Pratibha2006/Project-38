...
function setup() {
  ...
  trex = createSprite(displayWidth/2-50,displayHeight-100,20,50);
...
function draw() {
  ...
  background(255);
  textSize(22);
  text("Score: "+ score, displayWidth-200,displayHeight/2-150);
...
function spawnClouds() {
  ...
  if (frameCount % 60 === 0) {
    var cloud = createSprite(displayWidth,displayHeight/2-50,40,10);
    cloud.y = Math.round(random(200,500));
